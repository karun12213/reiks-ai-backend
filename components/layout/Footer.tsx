...
export default function Footer() {
    return (
        <footer className="bg-aureum-dark border-t border-aureum-border mt-auto pb-16 md:pb-0">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-2 md:col-span-1">
                        ...
                        <p className="text-xs text-aureum-dim mt-2 leading-relaxed max-w-xs">
                            India&apos;s first AI-native gold jewelry platform. Design with intelligence, invest with confidence.
                        </p>
                        <p className="text-[10px] text-aureum-dim mt-3 font-mono">Forged by Intelligence™</p>
                    </div>
                    ...
                    <div>
                        ...
                        <nav className="flex flex-col gap-2">
                            {[
                                ...
                                <Link key={link.href} href={link.href} className="text-xs text-aureum-mid hover:text-gold transition-colors">
                                    {link.label}
                                </Link>
                            ))}
                        </nav>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-2 text-xs text-aureum-mid">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-2 text-xs text-aureum-mid">
                            <a href="mailto:hello@aureum.in" className="hover:text-gold transition-colors">hello@aureum.in</a>
                ...
                <div className="mt-10 pt-6 border-t border-aureum-border flex flex-col sm:flex-row items-center justify-between gap-4">
                    <p className="text-[10px] text-aureum-dim">
